...
public class MonedasSQLiteHelper extends SQLiteOpenHelper{
    ...
    private static final String TABLE_CREATE = 
    			...
    			"moneda VARCHAR(3) NOT NULL PRIMARY KEY,"+
    			"ratio REAL DEFAULT '0' NOT NULL,"+
    			"bandera INTEGER DEFAULT '0' NOT NULL)";


	public MonedasSQLiteHelper(Context context, String name, CursorFactory factory, int version) {
